...
app = FastAPI(title="MediSpa API", version="1.0.0")
...
# Public-facing endpoint to accept consultation inquiries
@app.post("/inquiries")
...
# Optional: list recent inquiries (for internal use/testing)
...
@app.get("/inquiries", response_model=List[InquiryOut])
